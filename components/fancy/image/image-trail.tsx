...
interface ImageTrailProps extends HTMLAttributes<HTMLDivElement> {
  ...
  as?: ElementType
  /** px the mouse must travel before spawning the next item (default: 100) */
  threshold?: number
  /** momentum intensity, clamped to (0, 1] (default: 0.3) */
  intensity?: number
  ...
  /** how many times to repeat the children pool (default: 3) */
